...
public class DatabaseFromTeacher {
		...
		public static void main(String[] args) {
			DatabaseFromTeacher db = new DatabaseFromTeacher();
			...
			void removeData() {
				try {
					Scanner s = new Scanner(System.in);
					System.out.print("삭제할 교재 이름을 입력하세요 >>");
					tableName = s.nextLine();
					String removeStr = "DELETE FROM a where name='"+ tableName + "'";
			...
			void changeData() {
				try {
					String changeStr = "UPDATE a SET name='가나다'";
...
//					String viewStr2 = "SELECT * FROM a";
//					ResultSet result2 = stmt.executeQuery(viewStr2);
//					//int cnt2 = 0;
//					while(result2.next()) {
//						System.out.print(result2.getString("name") + "\t" + result2.getString("id") + "\t"
